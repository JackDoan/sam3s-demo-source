 ...
 */
 ...
 /* TI C6x supports complex arithmetic */
 #ifndef _C9X_COMPLEX
  #define _C9X_COMPLEX (_TMS320C6X || 199901L <= __STDC_VERSION__)
 #endif /* _C9X_COMPLEX */
 ...
 #if defined(__MSP430__) || defined(__TMS320C28X__) /* TI MSP430 or C2800 */
  ...
  #undef _D0 /* Default: LE 64-bit type */
  #define _DLONG 0 /* 0 means 32- or 64-bit long double */

  #if defined(__TMS320C28X__)
     #define _32_BIT_DOUBLE 1
     #undef _32_BIT_LDOUBLE
  #endif
  #define _FPP_TYPE	_FPP_NONE   /* software emulation */
 ...
 #else
    #undef _D0 /* Default: LE 64-bit */
    #define _32_BIT_DOUBLE 1
    #define _32_BIT_LDOUBLE 1
...
typedef  __SIZE_T_TYPE__ _Sizet;
 ...
 #define _HAS_C9X_IMAGINARY_TYPE	(_C9X_COMPLEX && __EDG__ \
	&& !defined(__cplusplus))
...
typedef _CSTD va_list _Va_list;
 ...
 #ifndef va_copy
_EXTERN_C
void _Vacopy(va_list *apd, va_list aps);
_END_EXTERN_C
